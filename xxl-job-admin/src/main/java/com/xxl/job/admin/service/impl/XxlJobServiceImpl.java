...
public class XxlJobServiceImpl implements XxlJobService {
    ...
    public PagedRetData<XxlJobInfo> pageList(int start, int length, int jobGroup, int triggerStatus, String jobDesc, String executorHandler, String author) {
        ...
        PagedRetData<XxlJobInfo> pagedRetData = new PagedRetData<XxlJobInfo>(list);
        ;
    ...
    public ReturnT<String> add(String username, XxlJobInfo jobInfo) {
        XxlJobUser nowUser = xxlJobUserDao.loadByUserName(username);
        return add(nowUser, jobInfo);
    }
    ...
    public ReturnT<String> add(XxlJobUser loginUser, XxlJobInfo jobInfo) {
        ...
        if (!hasPermission(loginUser, jobInfo.getJobGroup())) {
        ...
        String executorHandler = jobInfo.getExecutorHandler();
        if(StringUtils.hasText(executorHandler)){
            jobInfo.setExecutorHandler(executorHandler.trim());
        }
    ...
    public ReturnT<String> update(XxlJobUser loginUser, XxlJobInfo jobInfo) {
        ...
        //check exists group permission
        if (!hasPermission(loginUser, exists_jobInfo.getJobGroup())) {
            return new ReturnT<String>(ReturnT.FAIL.getCode(), I18nUtil.getString("system_permission_limit"));
        }
    ...
    public ReturnT<String> trigger(String username, int jobId, String executorParam, String addressList) {
        XxlJobUser nowUser = xxlJobUserDao.loadByUserName(username);
        return trigger(nowUser, jobId, executorParam, addressList);
    }
